...
export class CreditcardsComponent {
  ...
  constructor(private creditcardService:CreditcardService ){
    ...
    this.dataSources = new MatTableDataSource(this.creditCard);
    this.dataSources.paginator = this.paginator;
    this.dataSources.sort = this.sort;
    console.log('dddddddd',data);
    })
  }
  dataSources = new MatTableDataSource(this.creditCard);

  displayColumns = ['select', 'id', 'name', 'bankName', 'description', 'maxCredit', 'intrestRate', 'active', 'recommendedScore',"actions"];
